...
class Haromszog:
    ...
    def Betta(self):
        return math.degrees(math.acos((self.b**2 + self.c**2 - self.b**2)/(2*self.a*self.c)))
...
#a split az adatsort részekre bontja és elhelyezi egy szöveges tuplebe
#*operátor a tuplet fel osztja és hozzás rendeli a megfelelő paraméterekhez
